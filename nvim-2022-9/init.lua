...
-- global options
vim.opt.writebackup = false vim.opt.termguicolors = true
...
keyset("n", "<leader>p", '"+gp')
keyset("n", "<space>sv", ":source $MYVIMRC<cr>")
keyset("n", "<leader>z", "[s1z=``")
keyset("n", "<space>1", ":bp<cr>")
keyset("n", "<space>2", ":bn<cr>")
keyset("n", "<space>3", ":retab<cr>:FixWhitespace<cr>")
keyset("n", "<space>4", ":Format<cr>")
keyset("n", "<space>5", ":lua SpellToggle()<cr>")
...
keyset("n", "<space>fw", ":Telescope live_grep<cr>")
keyset("n", "<space>ff", ":Telescope find_files<cr>")
keyset("n", "<space>fb", ":Telescope buffers<cr>")
keyset("n", "<space>fm", ":Telescope man_pages<cr>")
keyset("n", "<space>ft", ":Telescope treesitter<cr>")
keyset("n", "<space>fk", ":Telescope keymaps<cr>")
keyset("n", "<space>fh", ":Telescope help_tags<cr>")
keyset("n", "<space>fd", ":Telescope file_browser<cr>")
keyset("n", "<space>fs", ':GrepperRg "" .<Left><Left><Left>')
keyset("n", "<space>fS", ":Rg<space>")
keyset("n", "<space>*", ":Grepper -tool rg -cword -noprompt<cr>")
keyset("n", "gs", "<Plug>(GrepperOperator)")
keyset("x", "gs", "<Plug>(GrepperOperator)")

-- fugitive
keyset("n", "<space>gg", ":Git<cr>", {silent = true})
keyset("n", "<space>ga", ":Git add %:p<cr><cr>", {silent = true})
keyset("n", "<space>gd", ":Gdiff<cr>", {silent = true})
keyset("n", "<space>ge", ":Gedit<cr>", {silent = true})
keyset("n", "<space>gw", ":Gwrite<cr>", {silent = true})
keyset("n", "<space>gf", ":Commits<cr>", {silent = true})
